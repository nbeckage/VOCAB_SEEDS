...
```{r}
all_bykid <- full_join( trigram_num_by_kid, trigram_freqs_by_kid%>% select(log_mean_trigram_frequency, target_child_id))
write_csv(all_bykid, "trigrams_by_kid_MIN1.csv")
